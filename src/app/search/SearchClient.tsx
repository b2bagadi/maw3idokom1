...
import AnimatedIconsBackground from '@/components/ui/AnimatedIconsBackground';
...
function SearchContent() {
    ...
    return (
        <div className="relative min-h-screen bg-gray-50 dark:bg-gray-900 pt-8 pb-16">
            <AnimatedIconsBackground className="opacity-60" intensity="subtle" />
